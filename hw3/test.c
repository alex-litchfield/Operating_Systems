...
void* processNextMove(void* args){
	...
	//int dead_end_boards_length = args1->dead_end_boards_length;
	//int *dead_end_boards_count = args1->dead_end_boards_count;
	int seen = args1->seen;	
	int m = args1->m;
	int n = args1->n;
	//int x = args1->x;
	...
	*returnSize = 0;
	...
	//This branch occurs if there is exactly only 1 possible move left
		...
		//args->dead_end_boards_length = dead_end_boards_length;
		//args->dead_end_boards_count = dead_end_boards_count;
		args->seen = seen + 1;
		args->m = m;
		args->n = n;
		//args->x = x;
...
int main(int argc, char** argv){
	...
	args->currPos[0] = 0;
	args->currPos[1] = 0;
	//args->dead_end_boards_length = 10;
	//args->dead_end_boards_count = &dead_end_boards_count;
	args->seen = 1;
	args->m = m;
	args->n = n;
